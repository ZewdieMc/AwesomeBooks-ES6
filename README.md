...
- Refactoring JS code to use modules and ES6 syntax in general.
  - Use [const](https://www.w3schools.com/js/js_const.asp) and [let](https://www.w3schools.com/js/js_let.asp) properly.
  - Use [arrow functions](https://www.w3schools.com/js/js_arrow_function.asp) to implement the app functionalities.
...
- The link to the [Live Demo](https://zewdiemc.github.io/AwesomeBooks-ES6/) of the project.
...
To run the project:
 - Open index.html
 - Open it with [Live Server](https://github.com/ritwickdey/vscode-live-server-plus-plus)
...
Feel free to check the [issues page](https://github.com/ZewdieMc/AwesomeBooks-ES6/issues).
